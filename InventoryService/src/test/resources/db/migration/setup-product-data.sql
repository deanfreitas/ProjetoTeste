...
VALUES ('SKU001', 'Test Product 1', true),
...
VALUES ('STORE001', 'Test Store 1'),
       ('STORE002', 'Test Store 2');

-- Initialize stock for some products (using foreign key codes)
INSERT INTO estoque (produto_sku, loja_codigo, quantidade)
VALUES ('SKU001', 'STORE001', 100), -- SKU001 at STORE001
